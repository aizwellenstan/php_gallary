...
function _init() { "use strict";
    $.AdminLTE.layout = { activate: function() { var a = this;
        ...
        $(document).off("click", a + " li a").on("click", a + " li a", function(a) { var d = $(this),
                ...
                e.slideDown(c, function() { e.addClass("menu-open"), f.find("li.active").removeClass("active"), h.addClass("active"), b.layout.fix() }) } e.is(".treeview-menu") && a.preventDefault() }) }, $.AdminLTE.controlSidebar = { activate: function() { var a = this,
